...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <ol class="breadcrumb">
            <li>Home</li>
            <li>Productos</li>
            <li><?php echo e($viewConfig['accion']); ?></li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">
                ...
                <article class="col-sm-12">
                    ...
                    >
                        <header>
                            <h2><?php echo e($viewConfig['accion']); ?></h2>              
                        </header>
        
                        <!-- widget content -->
                        <div class="widget-body">
                            <?php echo Form::model($product, $formOptions); ?>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <section class="col col-md-9 col-sm-12 col-xs-12">
                                            ...
                                            <label class="input">
                                                <?php echo Form::text('name', null, ['autofocus']); ?>
                                    ...
                                    <div class="row">
                                        <section class="col col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <label class="input">
                                                <?php echo Form::text('cost', null, ['data-type'=>'float']); ?>
                                        ...
                                        <section class="col col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <label class="input">
                                                <?php echo Form::text('profit_margin', null, ['data-type'=>'float']); ?>
                                        ...
                                        <section class="col col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <label class="input">
                                                <?php echo Form::text('price', null, ['data-type'=>'float']); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <label class="select">
                                                <?php echo Form::select('is_visible', ['0'=>'Oculto', '1'=>'Visible']); ?>
        ...
        <!-- IMAGENES -->
        <?php echo $__env->make('admin.components.images-uploader', ['model' => $product, 'resource' => 'products'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <!-- /IMAGENES -->
