                        ...
                        <div class="row">
                            ...
                            <div id="sliderImagenes" class="col-sm-12">
                                ...
                                <?php $__currentLoopData = $model->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div style="display: none" class="superbox-list sortable" data-id="<?php echo e($image->id); ?>">
                                        <a class="btn btn-mini btn-primary hide" data-id="<?php echo e($image->id); ?>">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a class="btn btn-mini btn-danger" data-id="<?php echo e($image->id); ?>">
                                            <i class="fa fa-trash-o"></i>
                                        </a>
                                        <img src="/content/<?php echo e($resource); ?>/thumb/<?php echo e($image->src); ?>" class="superbox-img" />
                                    </div>
...
<textarea class="hidden" id="superboxItem">
    <div style="display: none" class="superbox-list sortable" data-id="${id}">
        <a class="btn btn-mini btn-primary hide" data-id="${id}">
            <i class="fa fa-pencil"></i>
        </a>
...
<script>
    var ImageUploader = (function ($, w, undefined) {
        ...
        var resource = "<?php echo e($resource); ?>";
        ...
        function init () {
            ...
            $('.superbox-list .btn-primary').remove();
        }
