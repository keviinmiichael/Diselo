            ...
            <div class="panel panel-smart">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <p>Las presentes condiciones generales de uso de la página web, regulan los términos y condiciones de acceso y uso de DISELO.COM.AR, propiedad de KIM JAVIER TOMAS , con domicilio en DR. JUAN FELIPE ARANGUREN 3377, y con CUIT: 20-38454792-4, en adelante, «la Empresa», que el usuario del Portal deberá de leer y aceptar para usar todos los servicios e información que se facilitan desde el portal. El mero acceso y/o utilización del portal, de todos o parte de sus contenidos y/o servicios significa la plena aceptación de las presentes condiciones generales de uso.</p>
                    </div>
                <div class="panel-heading">
                    <h3 class="panel-title">Condiciones de uso:</h3>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Obligaciones del Usuario:</h3>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Responsabilidad del portal:</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Propiedad intelectual e industrial:</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Legislación aplicable, jurisdicción competente y notificaciones:</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
